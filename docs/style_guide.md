...
Pin all dependency versions explicitly. Centralize pins in `infra/envs/`. Use environment variables (not hardcoded strings) when referencing versions in scripts.
